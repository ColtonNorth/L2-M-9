...
def write_airsensor():
    while True:
        sleep(15)
        #Carbon, nitrogen, and voc level values initiated with random values within given threshold 
        carbonLevels = randint(0, 2000)
        nitrogenLevels = randint(0,100)
        vocLevels = randint(0,750)
